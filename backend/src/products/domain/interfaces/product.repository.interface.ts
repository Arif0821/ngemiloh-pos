...
export interface IProductRepository {
  ...
  create(data: Prisma.ProductUncheckedCreateInput, creatorId: string): Promise<Product>;
  ...
  createModifierGroup(productId: string, data: Prisma.ProductModifierGroupUncheckedCreateInput): Promise<ProductModifierGroup>;
  createModifierOption(groupId: string, data: Prisma.ProductModifierOptionUncheckedCreateInput): Promise<ProductModifierOption>;
