...
export class ProductsService {
  ...
  async update(
    ...
    if (
      ...
      Number(data.base_price) !== Number(product.base_price)
    ) {
      await this.productRepository.logPriceUpdate(
        adminId,
        id,
    ...
    const updateData = {
      ...
      base_price:
        data.base_price !== undefined ? data.base_price : product.base_price,
      is_active:
        data.is_active !== undefined ? data.is_active : product.is_active,
      is_out_of_stock:
        data.is_out_of_stock !== undefined
          ? data.is_out_of_stock
          : product.is_out_of_stock,
      sort_order:
        data.sort_order !== undefined ? data.sort_order : product.sort_order,
    };
  ...
  async updateModifierGroup(
    ...
    const updateData = {
      ...
      is_required:
        data.is_required !== undefined ? data.is_required : group.is_required,
      is_active:
        data.is_active !== undefined ? data.is_active : group.is_active,
      max_selections:
  ...
  async updateModifierOption(
    ...
    const updateData = {
      ...
      is_active:
        data.is_active !== undefined ? data.is_active : option.is_active,
      sort_order:
        data.sort_order !== undefined ? data.sort_order : option.sort_order,
    };
