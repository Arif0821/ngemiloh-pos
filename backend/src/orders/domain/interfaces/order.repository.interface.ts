import { Order, CashRegister, Setting, AuditLog, OrderRefund, Discount, Prisma } from '@prisma/client';
...
export interface OrderRepositoryInterface {
  ...
  findOrders(where: Prisma.OrderWhereInput, orderBy?: Prisma.OrderOrderByWithRelationInput, include?: Prisma.OrderInclude, take?: number, skip?: number): Promise<any[]>;
  ...
  createShift(data: Prisma.CashRegisterUncheckedCreateInput): Promise<CashRegister>;
  createOrderRefund(data: Prisma.OrderRefundUncheckedCreateInput): Promise<OrderRefund>;
  countRecentVoids(since: Date): Promise<number>;
  findShifts(where: Prisma.CashRegisterWhereInput, include?: Prisma.CashRegisterInclude, orderBy?: Prisma.CashRegisterOrderByWithRelationInput, take?: number): Promise<any[]>;
}
